...
class TIS_GrabberDLL(object):
    if sys.maxsize > 2**32 :
        ...
        #__tisgrabber = C.windll.LoadLibrary(str(Path(__file__).resolve().parent/"tisgrabber_x64.dll"))
        #__tisgrabber = C.windll.LoadLibrary(os.path.dirname(os.path.abspath(__file__)) + os.path.sep +"tisgrabber_x64.dll")
    else:
        __tisgrabber = C.windll.LoadLibrary("tisgrabber.dll")
        #__tisgrabber = C.windll.LoadLibrary(os.path.dirname(os.path.abspath(__file__)) + os.path.sep +"tisgrabber.dll")
